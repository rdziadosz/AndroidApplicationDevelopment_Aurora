...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected void onStop() {
        super.onStop();
        ((AuroraApplication) getApplication()).setBackgroundFetcher();
    }
    ...
    public static class LocationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("location_lon"));
            bindPreferenceSummaryToValue(findPreference("location_lat"));
        }
